...
import ComponentsIsland from "../../islands/garage/ComponentsIsland.tsx";

export default define.page(function GarageComponentsPage() {
  return (
    <div class="min-h-screen bg-gray-100">
      <Head>
        <title>Components - Garage - LifeOS</title>
      </Head>
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-gray-500">
                  Create parts and install them on vehicles
                </p>
              </div>
            </div>
            <a

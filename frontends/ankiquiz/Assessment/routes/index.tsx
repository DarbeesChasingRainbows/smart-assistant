...
export default define.page(function Home(_ctx) {
  return (
    <div class="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100">
      <Head>
        <title>AnkiQuiz - Smart Flashcard Learning</title>
        <meta name="description" content="Transform your learning with intelligent flashcards, Anki imports, and adaptive quizzes" />
      </Head>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center">
              <div class="shrink-0">
                <h1 class="text-2xl font-bold text-indigo-600">AnkiQuiz</h1>
              </div>
            </div>
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-8">
                ...
                <a href="/decks" class="text-gray-500 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                  Decks
                </a>
                <a href="/graph" class="text-gray-500 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                  Graph
                </a>
      ...
      <footer class="bg-gray-900 text-white py-12 px-4">
        <div class="max-w-7xl mx-auto text-center">
          <h3 class="text-2xl font-bold mb-4">AnkiQuiz</h3>
          ...
          <div class="mt-8 pt-8 border-t border-gray-800 text-gray-500">
            <p>&copy; 2024 AnkiQuiz. Built with Fresh, Deno, and .NET.</p>
          </div>
        </div>
      </footer>
    </div>

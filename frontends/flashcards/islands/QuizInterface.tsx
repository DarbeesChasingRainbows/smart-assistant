...
export default function QuizInterface() {
  ...
  const loadQuiz = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/quiz?${qs.toString()}`, {
        method: "POST",
      });
  ...
  const onSubmit = async () => {
    ...
    const normalizedCorrectAnswer = normalizeSpellingAnswer(
    ...
    if (isAudioCard.value) {
      if (normalizedUserAnswer === normalizedCorrectAnswer) {
        ...
        feedbackMessage =
          `❌ Incorrect spelling. The correct spelling was: ${currentCard.value.answer}`;
      }
    } else {
        ...
        <div class="card w-full bg-base-100 shadow-xl">
          <div class="card-body">
                      ...
                      <div class="space-y-4">
                        ...
                        <div class="flex justify-center">
                          <button
                            ...
                            onClick={() =>
                              speakWord(currentCard.value!.question)}
                              ...
                              ? (
                                ...
                                >
                                  <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    d="M19.114 5.636a9 9 0 010 12.728M16.463 8.288a5.25 5.25 0 010 7.424M6.75 8.25l4.72-4.72a.75.75 0 011.28.53v15.88a.75.75 0 01-1.28.53L6.75 16.5H4.51a.75.75 0 01-.71-.485A1.5 1.5 0 013 14.5v-5a1.5 1.5 0 01.2-.735.75.75 0 01.71-.485h2.24z"
                                  />
                                </svg>
                              )
                              : (
                                ...
                                >
                                  <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    d="M12.25 12.767v1.233a.75.75 0 001.5 0v-1.233a.75.75 0 00-1.5 0zm0-3.517v-.233a.75.75 0 011.5 0v.233a.75.75 0 01-1.5 0zm0 5.75v.233a.75.75 0 001.5 0v-.233a.75.75 0 00-1.5 0zM3.75 12h16.5m-16.5 0a.75.75 0 01.75-.75h16.5a.75.75 0 01.75.75m-16.5 0a.75.75 0 00.75.75h16.5a.75.75 0 00.75-.75"
                                  />
                                </svg>
                              )}
                          </button>
            ...
            {feedback.value && currentCard.value && (
              <div
                class={`alert mt-4 ${
                  feedback.value.includes("Correct")
                    ? "alert-success"
                    : "alert-error"
                }`}
              >

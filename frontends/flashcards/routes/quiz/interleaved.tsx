        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between items-center h-16">
            <div class="flex items-center">
              <a href={url("/")} class="text-2xl font-bold text-indigo-600">AnkiQuiz</a>
            </div>
            <div class="flex items-center space-x-4">
              <a href={url("/decks")} class="text-gray-600 hover:text-indigo-600">Decks</a>
              <a href={url("/quiz/interleaved")} class="text-indigo-600 font-medium">Interleaved Study</a>
            </div>
          </div>
        </div>
      </nav>

...
import { getMenuItemsByRole } from "../routes/menuConfig.tsx";
...
const MenuItemView: FunctionComponent<{
  item: MenuItem;
  currentPath: string;
  userRole?: string;
...
function Menu({ items, currentPath, userRole }: { items: MenuItem[]; currentPath: string; userRole?: string }) {
  return (
